...
began as a fork, and the `qbz-*` / `qconnect-*` crate names are from that
history — they stay. The docs and CI do not name the project it forked from or
link its issue tracker; keep it that way.
